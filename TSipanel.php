		...
		}			
{
	...
	$arr = Array('bootlogo', 'Cams-arm', 'Cams-mips', 'Icons-Panel', 'Icons-Panel-FHD', 'Picons', 'Plugins','Plugins-Backup','Plugins-Epg','Plugins-IPTV','Plugins-Multiboot','Plugins-Vpn','Plugins-Weather','Skins-HD','TS-Skins');
